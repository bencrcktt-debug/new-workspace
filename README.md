...
Remote results are cached by source: token-based X reads for 5 minutes, no-token public X reads for 30 minutes, legislative/news feeds for 15 minutes, events for 30 minutes, the TEC workbook for 6 hours, and the LRL directory for 24 hours.
